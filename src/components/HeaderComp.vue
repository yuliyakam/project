  ...
  <header>
    <nav class="nav center">
      <router-link class="link-nav" :to="'/'">
        <div class="logo-box">
          <img src="@/assets/images/l.png" alt="label" class="logo" />
        </div>
      </router-link>
      ...
      <div class="right-header-part">
        ...
        <div class="drop-down-menu">
          <ul class="menu">
            <li>
              <router-link :to="'/'" class="drop-menu-link"
                >Главная</router-link
              >
            </li>
            <li>
              <router-link :to="'/services'" class="drop-menu-link"
                >Услуги</router-link
              >
              ...
              <ul class="sub-menu">
                <li v-for="(link, index) in links" :key="index">
                  <router-link
                    :to="getLinkUrl(link.path)"
                    @click="scrollToBlock(link.path)"
                    class="sub-menu-link"
                  >
                    {{ link.title }}
                  </router-link>
            ...
            <li>
              <router-link :to="'/contacts'" class="drop-menu-link"
